...
| Авторегистрация аккаунтов (многопоточная)     | Поддерживаются практически все СМС-сервисы. Если не приходит долго код - номер автоматически отменяется. Можете просто указать, что вам нужно 100 аккаунтов, программа сама зарегистрирует, подгрузив аватарки, фамилию имя и био, как по вашему желанию так и из нашей базы. |
